interface PDFElement {
  id: string;
  type: string; // element type like div, img, custom types: "drawing", "shape", "image". default div.
...
export const insertAnnotations = (htmlContent: string, particles: Record<string, PDFElement[]>) => {
